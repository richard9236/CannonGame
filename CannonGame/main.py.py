...
class UIButton:
    ...
    def __init__(self, Window, Text, TextSize, TextColor, Hight, Length, PosX, PosY):
        self.Window = Window
    ...
    def TestIfWasButton(self, mousePos):
        WinHight , WinLength = self.Window.get_height(), self.Window.get_width()
    ...
    def Draw(self, bulletInt):
        if bulletInt != 5 :
            pygame.draw.rect(self.Window, (170, 170, 170), [self.PosX, self.PosY, self.Length, self.Hight])
...
# these are zombie
MiscTB[15] = pygame.transform.scale(MiscTB[15], pygame.math.Vector2(100, 100))
MiscTB[16] = pygame.transform.scale(MiscTB[16], pygame.math.Vector2(100, 100))

# wolf boy
MiscTB[17] = pygame.transform.scale(MiscTB[17], pygame.math.Vector2(150, 150))
MiscTB[18] = pygame.transform.scale(MiscTB[18], pygame.math.Vector2(150, 150))
...
def SpawnMonster(monsterType, intt): #will be the fast times at ridgmont high
    ...
    elif monsterType == 2: # a zombie
        monsterHealth, monsterSpeed, monsterImgInt = 25, 1.5, 15
    elif monsterType == 3: # a wolf
        monsterHealth, monsterSpeed, monsterImgInt = 50, 6, 17
...
def Main():
    ...
    ReloadB = UIButton(Window, "Reload!", 22, (0, 0, 128), 40, 77,    0,   200)
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                wutt = ReloadB.TestIfWasButton(mousePos)
                
                if (wutt != True and CannonBullets >= 1): # didn't click a button, and we have some ammo. Lets shoot
                ...
                elif wutt == True and (CannonBullets < CannonBulletLimit):# clicked the button
